...
export const fakerPlugin: VaguePlugin = {
  ...
  generators: {
    ...
    "person.fullName": wrap((options?: unknown) =>
      faker.person.fullName(typeof options === "object" ? options as Record<string, unknown> : undefined)
    ),
    ...
    "internet.email": wrap((options?: unknown) =>
      faker.internet.email(typeof options === "object" ? options as Record<string, unknown> : undefined)
    ),
    ...
    "phone.number": wrap((format?: unknown) =>
      faker.phone.number({ style: typeof format === "string" ? format as "human" | "national" | "international" : undefined })
    ),
    ...
    "date.past": wrap((options?: unknown) =>
      faker.date.past(typeof options === "object" ? options as Record<string, unknown> : undefined).toISOString()
    ),
    "date.future": wrap((options?: unknown) =>
      faker.date.future(typeof options === "object" ? options as Record<string, unknown> : undefined).toISOString()
    ),
    "date.recent": wrap((options?: unknown) =>
      faker.date.recent(typeof options === "object" ? options as Record<string, unknown> : undefined).toISOString()
    ),
    "date.birthdate": wrap((options?: unknown) =>
      faker.date.birthdate(typeof options === "object" ? options as Record<string, unknown> : undefined).toISOString().split("T")[0]
    ),
    ...
    "commerce.price": wrap((options?: unknown) =>
      faker.commerce.price(typeof options === "object" ? options as Record<string, unknown> : undefined)
    ),
    ...
    "image.url": wrap((options?: unknown) =>
      faker.image.url(typeof options === "object" ? options as Record<string, unknown> : undefined)
    ),
    ...
    "number.int": wrap((options?: unknown) =>
      faker.number.int(typeof options === "object" ? options as Record<string, unknown> : undefined)
    ),
    "number.float": wrap((options?: unknown) =>
      faker.number.float(typeof options === "object" ? options as Record<string, unknown> : undefined)
    ),
...
export function setFakerLocale(_locale: string): void {
  ...
  console.warn("setFakerLocale: In Faker 8+, locale is set at import time. Import from @faker-js/faker/locale/XX instead.");
}
